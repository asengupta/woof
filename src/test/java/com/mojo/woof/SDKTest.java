...
public class SDKTest {
  ...
  public void canTraverseGraph() {
    ...
    Record root =
        sdk.findNodes(ImmutableList.of("AST_NODE"), Map.of("type", "PROCEDURE_DIVISION_BODY"))
            .getFirst();
  ...
  public void canCreateIndividualUnconnectedNodes() {
    ...
    Map<String, Object> properties =
        Map.of("property1", "value1", "property2", "value2", "property3", "value3");
    List<String> labels =
        ImmutableList.of("LABEL1", "LABEL2", "LABEL3", "LABEL4", "LABEL5", "LABEL6", "LABEL7");
  ...
  public void canFindNodeBasedOnArbitraryProperty() {
    GraphSDK sdk = new GraphSDK(new Neo4JDriverBuilder().fromEnv());
    Map<String, Object> properties =
        Map.of("testProp", "testVal", "property2", "value2", "property3", "value3");
    List<String> labels =
        ImmutableList.of("LABEL1", "LABEL2", "LABEL3", "LABEL4", "LABEL5", "LABEL6", "LABEL7");
    Record node = sdk.createNode(new WoofNode(properties, labels));
    List<Record> foundNodes =
        sdk.findNodes(ImmutableList.of("LABEL7"), Map.of("testProp", "testVal"));
  }
}
